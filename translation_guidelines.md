# Правила перекладу Death Stranding 2 (Українська)

## Розділ 1: Правила перекладу

1.  **Збереження атмосфери:** Переклад має передавати меланхолійний, науково-фантастичний та іноді сюрреалістичний тон гри.
2.  **Власні назви та імена:**
    *   Імена персонажів та назви організацій транслітеруються (наприклад, *Fragile* — Фреджайл, *Bridges* — Бріджес).
    *   Якщо назва має явне смислове значення, яке важливо для сюжету, вона може бути адаптована (наприклад, *Drawbridge* — Дроубрідж, але з контекстом «розвідного мосту»).
3.  **Технічні терміни гри:**
    *   Терміни, що стали знаковими для серії, мають залишатися незмінними (наприклад, *Death Stranding* — Смертоносний Вихід, *BT* — BT / Викинуті на берег).
    *   Абревіатури організацій (UCA, APAC, APAS) залишаються латиницею, якщо в грі вони представлені як логотипи або офіційні коди.
4.  **Технічні теги:**
    *   Заборонено змінювати або перекладати будь-які теги в фігурних `{ }` або кутових `< >` дужках (наприклад, `{0}`, `<icon...>`, `<color...>`).
    *   Слідкуйте за пробілами навколо тегів, щоб не порушити відображення тексту.
5.  **Пунктуація:**
    *   Використовуйте українське тире `—` (Alt+0151) замість дефіса `-` у діалогах.
    *   Використовуйте лапки «ялинки» `« »`.
6.  **Звертання:**
    *   Використовуйте «ви» при офіційному звертанні та «ти» між близькими персонажами (наприклад, Сем та Фреджайл). Кличний відмінок є обов'язковим (Семе, Фреджайл, Лу).

---

## Розділ 2: Словник специфічних термінів

### Основні поняття та явища
| Англійська | Українська | Коментар |
| :--- | :--- | :--- |
| Beach | Берег | Простір між життям і смертю |
| Beach mapping | картографування Берега | |
| Big Five | Велика п'ятірка | Вимирання |
| Chiral Network | Хіральна мережа | Система зв'язку |
| Chiral Printer | Хіральний принтер | Пристрій для створення речей |
| Chiralium | Хіралій | Ресурс/матерія |
| Death Stranding | Смертоносний Вихід | Глобальна катастрофа |
| DOOMS | ДУМС | Здібності відчувати ВТ |
| Extinction entity (EE) | сутність вимирання | |
| Ka / Ha | Ка / Ха | Душа / Тіло |
| Last Stranding | Останній Вихід | |
| Necro | Некро | Процес перетворення на ВТ |
| Nirvana | Нірвана | |
| Repatriate | Репатріант | Той, хто може повертатися після смерті |
| saṃsāra | сансара | |
| Seam | Шов | Підводний простір, куди потрапляє Сем |
| Sixth Extinction | Шосте вимирання | |
| Stillbaby syndrome | Синдром мертвонародженості | Стан, пов'язаний з BB |
| Tar | Смола | Чорна субстанція, пов'язана з ВТ |
| Timefall | Темпоральний дощ | Дощ, що прискорює час |
| Upper Beach | Верхній Берег | |
...
| Англійська | Українська | Коментар |
| :--- | :--- | :--- |
| active skeleton | активний скелет | |
| AED | АЗД | Автоматичний зовнішній дефібрилятор |
| auto-paver | Автоукладальник | Для будівництва доріг |
| battle skeleton | бойовий скелет | |
| BB Pod | Капсула BB | |
| beach yeast | берегові дріжджі | |
| bleed-through effect | ефект взаємопроникнення | про спогади ББ |
| Blood boomerang | кров'яний бумеранг | |
| Bokka | Бокка | Гірський кур'єр |
| bola gun | боломет | |
| bola stun gun | шоковий боломет | |
| boost skeleton | швидкісний скелет | |
| brinicles | брайнікли | |
| BT crystal | кристал Тварі | |
| BT Hologrenade | ТП-голограната | |
| burrowing bomb | кротова бомба | |
| cairn | курган | кам'яна піраміда |
| cargo catapult | Вантажна катапульта | |
| Climbing Anchor | штурмовий якір | |
| Coffin mech | мех «Труна» | |
| container repair spray | спрей для ремонту контейнерів | |
| convergence | конвергенція | Злиття душ і серверів |
| cooling unit | блок охолодження | |
| Decoy Hologrenade | голограната-приманка | |
| DHV | Глибокосмоляне мисливське судно | (Deep-tar Hunting Vessel) |
| dog mech | меха-пес | |
| drone syndrome | дроновий синдром | |
| Electric Rod | електро-жезл / електростержень | |
| electrical conversion device | пристрій перетворення електрики | |
| electrobiote | електробіонт | |
| electromagnetic shield | електромагнітний щит | |
| environmental anomaly | екологічна аномалія | |
| EX Grenade | ЕХ-граната | |
| EX Capture Grenade | граната ЕХ-захоплення | |
| fabricator terminal | термінал фабрикатора | |
| fire-extinguishing tar | вогнегасна смола | |
| floating carrier | левітуючий транспортер | |
| gate quake | розлом воріт (портальний землетрус) | |
| Gordian knot | Гордіїв вузол | |
| hologrenade | голограната | |
| hot spring jump | стрибок у гаряче джерело | |
| ice pillars | крижані колони | |
| icicles of death | бурульки смерті | |
| inverted rainbow | перевернута веселка | |
| isolation ward | ізолятор | |
| keep flat | тримати горизонтально | маркування вантажу |
| Kraken mech | мех «Кракен» | |
| Ludens Duck | Качка-люденс | |
| macropod | кенгуровий | |
| monotremes | однопрохідні | |
| multirocket launcher | багаторакетна установка | |
| necrobiote | некробіонт | |
| odradek | одрадек | Сканер кур'єра |
| optical jamming | оптичний джаммінг | |
| PCC Lv3 | ПКК-3 | |
| phantom gas grenade | примарна газова граната | |
| pizza-do karate | Піца-До карате | |
| pod | колби | контейнер ББ |
| polytope | Політоп | |
| propulsion system | силова установка | |
| quipu | квіпу | вузликове письмо |
| RD grenade launcher | гранатомет РД | (Remote Detonation) |
| red mist | червоний туман | |
| remote medical unit | дистанційний медичний блок | |
| Remote Stun Bomb | дистанційна приголомшлива бомба | |
| Rider mech | мех «Наїзник» | |
| sacrificial BB | жертовний BB | |
| safe house | Притулок | |
| sandalweed | сандалове зілля | |
| security vehicle | машина безпеки | |
| sentry guns | автоматичні турелі | |
| separation of Ka and Ha | роз'єднання Ка та Ха | |
| SSS | SSS | Соціальна система синхронізації |
| Stealth Hologrenade | маскувальна голограната | |
| Sticky Gun | липка гармата (липуча гармата) | |
| strand | Нить | Мотузка / зв'язок |
| strand contract | Нитяний контракт | |
| Stun Bomb | приголомшлива бомба | |
| Taekwondoll | Тхеквондоля | |
| tarfall | смолепад | |
| timefall shelter | темпоральне укриття | |
| twenty-one minute syndrome | синдром двадцяти однієї хвилини | |
| Warrior Assault Rifle | штурмова гвинтівка «Воїн» | |
| Warrior Shotgun | дробовик «Воїн» | |
| zip-line | Тролей | |
| zip-line anchor | якір тролея | |

### Фрази та Сленг
| Англійська | Українська | Коментар |
| :--- | :--- | :--- |
| hard yakka | важка праця | австралійський сленг |
| Hiya-peko | Привіт-пеко | вітання Пекори |
| konpeko / Konpeko | конпеко | фраза Пекори |
| otsupeko | оцупеко | фраза Пекори |
| peko | пеко | часточка в мові Пекори |
| trick or treat | ласощі або капость | |
